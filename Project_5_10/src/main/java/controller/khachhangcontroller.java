		...
		try {
			...
			if(taiKhoan != null) {
				if(taiKhoan.getRole().equals("khachhang")) {
					System.out.println("khach hang dang nhap");
					...
					System.out.println("Ma Tai Khoan: " + khachHang.getMaTaiKhoan());
					...
					System.out.println("Ma Tai Khoan: " + nhanVien.getHoVaTen());
					session = request.getSession();
					session.setAttribute("taiKhoan", taiKhoan);
					session.setAttribute("nhanVien", nhanVien);
					System.out.println("nhan vien 1234");
