...
public class ChuyenBayDAO implements DAOInterface<ChuyenBay> {
	...
	public static ArrayList<ChuyenBay> selectByBeforeDate(ArrayList<ChuyenBay> cb) {
        LocalDateTime now = LocalDateTime.now();
        ArrayList<ChuyenBay> allBefore = new ArrayList<>();

        if (cb != null) {
            for (ChuyenBay c : cb) {
                if (c != null && c.getNgayBay() != null && c.getGioBay() != null) {
                    LocalDate flightDate = c.getNgayBay().toLocalDate();
                    LocalTime flightTime = c.getGioBay().toLocalTime();
	...
	public static ArrayList<ChuyenBay> selectByAfterDate(ArrayList<ChuyenBay> cb) {
		LocalDateTime now = LocalDateTime.now();
	    ArrayList<ChuyenBay> allBefore = new ArrayList<>();
	...
	public static void main(String[] args) {
		System.out.println(new ChuyenBayDAO().selectByID("CB1"));
	}
