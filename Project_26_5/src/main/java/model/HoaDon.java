...
public class HoaDon {
	...
	public String toString() {
		return "HoaDon [maHoaDon=" + maHoaDon + ", maKhachHang=" + maKhachHang + ", maChuyenBayDi=" + maChuyenBayDi
				+ ", maChuyenBayVe=" + maChuyenBayVe + ", maGheDi=" + maGheDi + ", maGheVe=" + maGheVe + ", donGia="
				+ donGia + ", ngayDat=" + ngayDat + ", gioThanhToan=" + gioThanhToan + "]";
	}
