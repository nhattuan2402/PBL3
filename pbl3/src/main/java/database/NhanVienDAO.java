	...
	// cập nhật thông tin nhân viên
		...
		public static void themNhanVien(NhanVien nv) {
			try {
				...
				st.setString(1,nv.getMaTaiKhoan());
				st.setString(2, nv.getTenDangnhap());
				st.setString(3, nv.getMatKhau());
		...
		public static void main(String[] args) {
			NhanVien nv = new NhanVien("NV4", "Ba Quoc", new Date(2004-1900, 1-1, 1), "070712345", "BaQuoc@gmail.com", "Hue", true, "TKNV4", "BaQuoc", "123");
			themNhanVien(nv);
		}
}
