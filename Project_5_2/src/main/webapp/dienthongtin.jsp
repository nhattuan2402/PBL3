                ...
                <div class="container__form navbar__dangNhap">
                        ...
                        <div class="row">
                            <div class="formdangnhap-row">
                                <div class="col-xs-12 col-md-12">
                                    <div class="move-top">
                                        <input name="signin__memberEmail" type="text" id="memberEmailSignIn" class="form-control move-top-input" maxlength="120" placeholder="Nhập email" required />
                            ...
                            <div class="formdangky-row">
                                <div class="col-xs-12 col-md-12">
                                    <div class="fullName-container">
                                        <input name="signin__memberpassword" type="password"class=" formdangky-row__input form-control " id="memberPasswordSignIn" placeholder="password" required/>
                                        <div class="warning"></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row ">
                            <div class="col-xs-12 col-sm-12">
                                <button type="button" class="btnSubmitEnroll" value="Dangnhap" onclick=" return kiemtraInputDangNhap('memberEmailSignIn','memberPasswordSignIn')">Đăng Nhập</button>
                            </div>
                        </div>
                        <div class="row ">
                ...
                <div class="navbar__dangKy" id="formEnroll">
                    <div class="navbar__formdangky">
                            <div class="row">
                                ...
                                <div class="navbar__formdangky__icon-exit col-xs-2  col-md-2 navbar__formdangky__icon-exit  exit"  title="Hủy Đăng Ký"><i class="fa fa-times " aria-hidden="true"></i></div>
                            </div>
                        <div class="row">
                            <div class="formdangky-row">
                                <span class="desc col-xs-12 col-md-12">Đăng ký tài khoản thành viên hoàn toàn miễn phí để sử dụng.Hãy click vào phần chọn nhận thông báo để nhận ưu đãi mới nhất.</span>
                            ...
                            <div class="formdangky-row">
                                <p class="form-title col-xs-12 col-md-4">
                                    ...
                                    <div class="formdangky-row__gender">
                                        ...
                                        <input class="formernoll-gender" id="female" type="radio"  name="gender" value="0">
                                    </div>
                                </p>
                        ...
                        <div class="row">
                            <div class="formdangky-row">
                                ...
                                <div class="col-xs-12 col-md-8">
                                    <div class="fullName-container">
                                        <input name="fullName" type="text" id="fulltNameSignUp" class=" formdangky-row__input form-control " placeholder="Nhap ho va ten"/>
                                        <div class="warning"></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <fieldset class="birthdayPicker">
                                    <div class="col-xs-4 col-md-4">
                                        <div class="move-top"><label for="enroll-birth-date" class="move-top-label" id="enroll-birth-date-label">Ngày</label>
                                            <select class="birthDate form-control selectBox selectBoxDefault move-top-input icon-sort span2" id="enroll-birth-date" >
                            ...
                            <div class="formdangky-row">
                                ...
                                <div class="col-xs-12 col-md-8">
                                    <div class="move-top" id="company-city-select" style="display: none;">
                                        <select name="content_0$ddlLotusMilesEnrollCompanyDistrict" id="ddlLotusMilesEnrollCompanyDistrict" class="form-control "></select>
                                    </div>
                                    <div class="move-top" id="company-city-input">
                                        <input name="companyCity" type="text" id="companyCity" class="form-control " maxlength="32" placeholder="Nhap dia chi" />  
                                        <div class="warning"></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="formdangky-row">
                                ...
                                <div class="col-xs-12 col-md-8">
                                    <div class="move-top">
                                        <input name="memberEmailSignUp" type="text" id="memberEmailSignUp" class="form-control" maxlength="120" placeholder="Nhap email" />
                                        <div class="warning"></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="formdangky-row">
                                ...
                                <div class="col-xs-12 col-sm-3">
                                    <div class="move-top">
                                        <select name="ddlLotusMilesEnrollMobileCountry" id="ddlLotusMilesEnrollMobileCountry" class="form-control selectBox " style="font-size: small;">
                                ...
                                <div class="col-xs-12 col-sm-5">
                                    <div class="move-top">
                                        <input name="mobileNumber" type="text" id="mobileNumberSignUp" class="form-control move-top-input" maxlength="12" autocomplete="off" placeholder="Nhap so dien thoai" />
                                        <div class="warning"></div>
                        ...
                        <div class="row">
                            <div class="formdangky-row">
                                ...
                                <div class="col-xs-12 col-md-8">
                                    <div class="move-top">
                                        <input name="memberpassword" id="memberPasswordSignUp" type="password"class=" formdangky-row__input form-control " placeholder="Nhap mat khau"/>
                                        <div class="warning"></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="formdangky-row check-item ">
                                <input type="checkbox" id="dongyVoiDieuKhoan" name="terms" value="agree">
                                <label for="dongyVoiDieuKhoan" id="check">Tôi đồng ý với các <a href="#">điều khoản</a></label>
                                <div class="warning"></div>
                            </div>
                        </div>
                        <div class="row ">
                            <div class="formdangky-row check-item ">
                                <input type="checkbox" id="nhanthongbao" name="alerts" value="latest">
                                <label for="nhanthongbao">Gửi cho tôi thông báo mới nhất</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-12">
                                <button type="button" class="btnSubmitEnroll " value="Dangky" onclick=" return kiemtraInputDangKy('fulltNameSignUp','enroll-birth-date', 'enroll-birth-month', 'enroll-birth-year', 'companyCity','memberEmailSignUp','mobileNumberSignUp','memberPasswordSignUp','dongyVoiDieuKhoan','nhanthongbao')">Tạo Tài Khoản</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="content">
                            <div class="row">
                                <div class="phieuYeuCauHoTro-row">
                                    ...
                                    <div class="col-xs-12 col-md-8">
                                        <input name="vanDeCSKH" id='VanDe__CSKH'type="text"class=" form-control " placeholder="Vấn đề">
                                        <div class="warning"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="phieuYeuCauHoTro-row">
                                    ...
                                    <div class="col-xs-12 col-md-8">
                                        <div class="move-top">
                                            <input name="memberEmailCSHK" id="Email__CSKH" type="text"class="form-control " maxlength="120" placeholder="Nhập email" />
                                            <div class="warning"></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="phieuYeuCauHoTro-row">
                                    ...
                                    <div class="col-xs-12 col-md-5">
                                        <input name="vanDeCSKH" id="MaVe__CSKH" type="text"class=" form-control " placeholder="Mã vé">
                                        <div class="warning"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="phieuYeuCauHoTro-row">
                                    <div class="form-title col-xs-12 col-md-12">
                                        <textarea  class="phieuYeuCauHoTro__Noidungchitiet" id="ChiTietYeuCau__CSKH" cols="79" rows="4" name=" mô tả" wrap="PHYSICAL"></textarea>
                                        <div class="warning"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    <button type="button" class="btnSubmitformCSKH " value="Gui" onclick="return kiemtraInputPhieuHoTro('VanDe__CSKH','Email__CSKH','MaVe__CSKH','ChiTietYeuCau__CSKH')">Gửi</button>
                                </div>
                            </div>
                            <div class="row">
                                <div class="phieuYeuCauHoTro__LuuY-row">
                                    <span class="desc col-xs-12 col-md-12">Lưu ý <span class='required'>*</span>: Bộ phận cskh sẽ tiếp nhận yêu cầu hỗ trợ của bạn và phản hồi qua thư điện tử liên lạc của bạn, để biết thêm chi tiết vui lòng liên hệ qua số Holine:<a>19000091212</a>.</span>
                                </div>
                            </div>
                    </form>
                </div>
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img src="assets/images/logo.jpg" class="img_chania.jpg" alt="LOGO"></a>
            </div>
            <div class="collapse navbar-collapse" id="abc">
                <ul class="nav navbar-nav navbar-right">
                    <li class="active"><a href="index.html" class="muaVeVaSanPham">Mua vé & Sản phẩm</a></li>
                    <li><a href="#" class="hoTro">Hỗ trợ</a></li>
                    <li><a href="#" class="dangnhap">Đăng nhập</a></li>
                    <li class="dangky">
                        <a class="dangky" hef="#formEnroll">Đăng Ký</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <!--Kết thúc header-->
            ...
            <div class="container">
                <div class="row">
                    <div class="thongTinHanhKhach__tieuDe row col-xs-12  col-md-7 ">
                        <div class="title title--thongTinHanhKhach row">Thông tin hành khách</div>
                        <div class="desc desc--thongtinhanhkhach">Nhập thông tin cần thiết cho mỗi hành khách và đảm bảo rằng thông tin đó khớp chính xác với ID do chính phủ cấp được xuất trình tại sân bay.</div>
                    </div> 
                     <div class="thongTinHanhKhach col-xs-12  col-md-7 ">
                        <div class="thongTinHanhKhach__BoxDienThongTin" id="box-dienThongTinNguoiLon">
                            <div class="desc desc--boxThongtin">Hành khách <span id="stt-HanhKhach__dienthongtinHK">1</span> (Người lớn)</div>
                            <div class="thanhNhapThongTin thanhNhapThongTin--row0">
                                <div class="boxnhapthongtinHK">
                                    <input type="text"  class="theInput form-control" placeholder="Họ Và Tên*"/>
                                    <div class="warning"></div>
                                </div>
                                <div class="boxnhapthongtinHK">
                                    <input type="text" class="theInput form-control" placeholder="Ngày sinh*"/>
                                    <div class="boxmota">
                                        <div class="desc desc--moTaNgaySinh">DD/MM/YY  Ví Dụ:25/5/1982</div>
                                        <div class="warning"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="thanhNhapThongTin thanhNhapThongTin--row1">
                                <div class="boxnhapthongtinHK">
                                    <input type="text" class="theInput form-control" placeholder="Email*"/>
                                    <div class="warning"></div>
                                </div>
                                <div class="boxnhapthongtinHK">
                                    <input type="text" class="theInput form-control" placeholder="Số Điện Thoại*"/>
                                    <div class="warning"></div>
                                </div>
                            </div>
                            <div class="thanhNhapThongTin">
                                <div class="boxnhapthongtinHK">
                                    <input type="text" class="theInput form-control" placeholder="Địa Chỉ"/>
                                    <div class="warning"></div>
                                </div>
                                <div class="boxnhapthongtinHK">
                                    <input type="text"  class="theInput form-control"placeholder="Quốc Tịch"/>
                                    <div class="warning"></div>
                                </div>
                            </div>
                            <div class="thanhNhapThongTin">
                                <div class="boxnhapthongtinHK">
                                    <input type="text"  class="theInput form-control"placeholder="Giới Tính"/>
                                    <div class="boxmota">
                                ...
                                <div class="boxnhapthongtinHK">
                                    <input type="text" class="theInput form-control" placeholder="CCCD/CMND"/>
                                    <div class="warning"></div>
                                </div>
                            </div>
                        </div>
                        <div class="thongTinHanhKhach__BoxDienThongTin" id="box-dienThongTinTreEm">
                            <div class="desc desc--boxThongtin">Hành khách <span id="stt-HanhKhach__dienthongtinHK">2</span> (Trẻ em)</div>
                            <div class="thanhNhapThongTin thanhNhapThongTin--row0">
                                <div class="boxnhapthongtinHK">
                                    <input type="text"  class="theInput form-control" placeholder="Họ Và Tên*"/>
                                    <div class="warning"></div>
                ...
                <div class="row">
                    <div class="thongTinHanhKhach__tieuDe row  row col-xs-12  col-md-7">
                        <div class="desc desc--thongtinhanhkhach desc--boxThongtin">Thông tin hành lý</div>
                        <div class="desc desc--thongtinhanhkhach">Mỗi hành khách được phép mang theo một túi xách tay miễn phí và một vật dụng cá nhân. Hành lý ký gửi đầu tiên cho mỗi hành khách cũng được miễn phí. Xem chính sách hành lý đầy đủ.</div>
                        
                        <div class="thongTinHanhKhach__chiTietKyGui">
                            <div class="chiTietKyGui__ThanhPhan desc--thongtinhanhkhach">
                                <div class="chiTietKyGui__ThanhPhan-TenHanhKhach">Hành khách </div>
                                <div class="chiTietKyGui__ThanhPhan-HanhLyKyGui">Hành lý ký gửi</div>
                            </div>
                            <div class="chiTietKyGui__ThanhPhan desc--thongtinhanhkhach desc--boxThongtin">
                                <div class="chiTietKyGui__ThanhPhan-TenHanhKhach">Nguyen Van A</div>
                                <div class="chiTietKyGui__ThanhPhan-HanhLyKyGui">
                                    <button type="button" class="HanhLyKyGui--thanhphan">-</button>
                                    <div class="HanhLyKyGui--thanhphan" id="chiTietKyGui-SoLuongHanhKyGui">1</div>
                                    <button type="button" class="HanhLyKyGui--thanhphan">+</button>
                                </div>
                            </div>
                            <div class="chiTietKyGui__ThanhPhan desc--thongtinhanhkhach desc--boxThongtin">
                                <div class="chiTietKyGui__ThanhPhan-TenHanhKhach">Nguyen Van B </div>
                                <div class="chiTietKyGui__ThanhPhan-HanhLyKyGui">
                                    <button type="button" class="HanhLyKyGui--thanhphan">-</button>
                                    <div class="HanhLyKyGui--thanhphan" id="chiTietKyGui-SoLuongHanhKyGui">1</div>
                                    <button type="button" class="HanhLyKyGui--thanhphan">+</button>
                    ...
                    <div class="thongTinHanhKhach__HinhAnhMoTa row col-xs-12  col-md-5">
                        <img src="assets/images/hanhLy__NhapThongTinHK.png" class="img_HanhLy" alt="Hành Lý Cho Phép"> 
                        <div class="desc desc--thongtinhanhkhach">*Kích thước bao gồm tay cầm và bánh xe</div>
                    </div>
                </div>
                 <!--/. nhập thông tin khach hàng - nhập số hành lý ký gửi -->
                ...
                <!-- thanh chuyen tiep-->
                <div class="row">
                    <div class="thanhchuyentiep" id="thanhchuyentiep-chonchuyenve">
                        <button type="button" class="_btnQuayLai" id="btn__quaylai-DienThongTin">Quaylai</button>
                        <div class="tongtienchuyenbay">
                            <span class="tongtien">Tổng Tiền:</span>
                            <span class="tongtien" id="thanhchuyentiep-DienThongTin-tongtien">0</span><span>.000VND</span>
                        </div>
                        <button type="button" class="_btnChuyenTiep" id="btn__chuyentiep-DienThongTin">Tiếp theo</button>
                    </div>
                </div>
                <!-- /.thanh chuyen tiep-->
     ...
     <div class="container">
        <div class="row">
            <div class="chanTrang">
            <div class="col-sm-3">
                <a><img src="assets/images/logo.jpg" class="img_chania.jpg" alt="LOGO"></a>
            </div>
            <div class="col-sm-3">
                <div class="chanTrang">
