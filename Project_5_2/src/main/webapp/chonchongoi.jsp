...
<body>
	<div class="container-fluid">
		<div class="row">
			<div class="maTranViTriChoNgoi col-xs-12  col-md-5"></div>
			<div class="thongTinChoNgoi col-xs-12  col-md-5">
				<div class="row">
					<div class="thongTinChoNgoi__thongtinhanhtrinh">
						<div class="thongTinChoNgoi__thongtinhanhtrinh-thanhphan">
							<div class="desc--boxThongtin tieude">Hà Nội</div>
							<div class="tieude move-top-label">vietnam</div>
						</div>
						<div class="thongTinChoNgoi__thongtinhanhtrinh-thanhphan">
							<div class="desc--boxThongtin tieude">Huế</div>
							<div class="tieude move-top-label">vietnam</div>
						</div>
						<div class="thongTinChoNgoi__thongtinhanhtrinh-thanhphan"></div>
					</div>
				</div>
			</div>
		</div>
